...
const ReadOnlyProjectTrackerRow = memo(function ReadOnlyProjectTrackerRow({
  ...
  return (
    <tr className="group">
      ...
      <td
        className="sticky left-0 z-10 border-r border-b border-border px-3 py-2.5"
      ...
      <td
        className="sticky z-10 border-r border-b border-border px-3 py-2.5 text-[13px] text-navy whitespace-nowrap overflow-hidden text-ellipsis max-w-[240px]"
        style={{
          left: 84,
